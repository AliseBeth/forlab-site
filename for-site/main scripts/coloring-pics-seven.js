...
setInterval(function() {
    ...
    let chosenPicFive = (Math.floor(Math.random() * (max - min) + min));
    let chosenPicSix = (Math.floor(Math.random() * (max - min) + min));
    let chosenPicSeven = (Math.floor(Math.random() * (max - min) + min));
    ...
    containerPics[chosenPicFive].classList.add('colored');
    containerPics[chosenPicSix].classList.add('colored');
    containerPics[chosenPicSeven].classList.add('colored');
}, 3000); 